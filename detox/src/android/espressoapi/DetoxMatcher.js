...
class DetoxMatcher {
  ...
  static matcherForContentDescription(contentDescription) {
    if (typeof contentDescription !== "string")
      throw new Error(
        "contentDescription should be a string, but got " +
          (contentDescription + (" (" + (typeof contentDescription + ")")))
      );
    return {
      target: {
        type: "Class",
  ...
  static matcherForTestId(testId) {
    if (typeof testId !== "string")
      throw new Error(
        "testId should be a string, but got " +
  ...
  static matcherForAnd(m1, m2) {
    if (
      typeof m1 !== "object" ||
      typeof m1.constructor !== "function" ||
      m1.constructor.name.indexOf("Matcher") === -1
    ) {
      ...
      const additionalErrorInfo = isObject
        ...
        : "it is no object";
      throw new Error(
        'm1 should be an instance of Matcher, got "' +
          m1 +
          '", it appears that ' +
          additionalErrorInfo
      );
    ...
    if (
      typeof m2 !== "object" ||
      typeof m2.constructor !== "function" ||
      m2.constructor.name.indexOf("Matcher") === -1
    ) {
      ...
      const additionalErrorInfo = isObject
        ...
        : "it is no object";
      throw new Error(
        'm2 should be an instance of Matcher, got "' +
          m2 +
          '", it appears that ' +
          additionalErrorInfo
      );
  ...
  static matcherForNot(m) {
    if (
      ...
      m.constructor.name.indexOf("Matcher") === -1
    ) {
      ...
      const additionalErrorInfo = isObject
        ...
        : "it is no object";
      throw new Error(
        'm should be an instance of Matcher, got "' +
          m +
          '", it appears that ' +
          additionalErrorInfo
      );
    ...
    if (
      ...
      const additionalErrorInfo = isObject
        ? typeof ancestorMatcher.constructor === "object"
          ? "the constructor is no object"
          : 'it has a wrong class name: "' +
            ancestorMatcher.constructor.name +
            '"'
        : "it is no object";
      throw new Error(
        'ancestorMatcher should be an instance of Matcher, got "' +
          ancestorMatcher +
          '", it appears that ' +
          additionalErrorInfo
      );
    ...
    if (
      ...
      const additionalErrorInfo = isObject
        ? typeof descendantMatcher.constructor === "object"
          ? "the constructor is no object"
          : 'it has a wrong class name: "' +
            descendantMatcher.constructor.name +
            '"'
        : "it is no object";
      throw new Error(
        'descendantMatcher should be an instance of Matcher, got "' +
          descendantMatcher +
          '", it appears that ' +
          additionalErrorInfo
      );
  ...
  static matcherForClass(className) {
    if (typeof className !== "string")
      throw new Error(
        "className should be a string, but got " +
  ...
  static matcherForAtIndex(index, innerMatcher) {
    ...
    if (
      ...
      const additionalErrorInfo = isObject
        ...
        : "it is no object";
      throw new Error(
        'innerMatcher should be an instance of Matcher, got "' +
          innerMatcher +
          '", it appears that ' +
          additionalErrorInfo
      );
